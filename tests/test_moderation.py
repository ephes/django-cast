...
def test_lots_of_unknown_tokens_lead_to_ham_if_spam_has_more_words():
    """
    There was a bug calculating the probabilities for unknown tokens:

    The probability for unknown tokens was calculated as 0.5 / number_of_words_in_class.
    Since there are much more tokens in spam than in ham, the probability for unknown tokens
    was much higher for ham than for spam. This lead to comments with lots of unknown tokens
