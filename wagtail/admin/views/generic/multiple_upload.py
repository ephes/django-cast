...
class AddView(PermissionCheckedMixin, TemplateView):
    ...
    def get_edit_object_response_data(self):
        ...
        return {
            ...
            "form": render_to_string(
                self.edit_form_template_name, self.get_edit_object_form_context_data(), request=self.request
            ),
        }
    ...
    def get_edit_upload_response_data(self):
        ...
        return {
            ...
            "form": render_to_string(
                self.edit_form_template_name, self.get_edit_upload_form_context_data(), request=self.request
            ),
        }
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            self.object = self.model(
                title=self.request.FILES["files[]"].name, collection_id=self.request.POST.get("collection")
            )
