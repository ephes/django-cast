...
class CreateView(TemplateResponseMixin, ContextMixin, HookResponseMixin, View):
    ...
    def form_invalid(self, form):
        messages.validation_error(self.request, _("The page could not be created due to validation errors"), self.form)
                ...
                translations = [
                    {
                        ...
                        "url": reverse(
                            ...
                            args=[self.page_content_type.app_label, self.page_content_type.model, self.parent_page.id],
                        )
                        + "?"
                ...
                translations = [
                    {
                        ...
                        "url": reverse(
                            "wagtailadmin_pages:add",
                            args=[self.page_content_type.app_label, self.page_content_type.model, translation.id],
                        ),
                    }
