...
class LogEntriesView(ReportView):
    ...
    list_export = ["object_id", "label", "object_verbose_name", "action", "timestamp"]
    ...
    def get_queryset(self):
        ...
        return (
            PageLogEntry.objects.filter(q).select_related("user", "user__wagtail_userprofile").prefetch_related("page")
        )
