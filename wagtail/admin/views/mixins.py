...
class SearchableListMixin:
    ...
    def get_search_form(self):
        return SearchForm(
            self.request.GET if self.request.GET.get("q") else None, placeholder=self.search_box_placeholder
        )
    ...
    def get_queryset(self):
        ...
        if search_form.is_valid():
            ...
            if class_is_indexed(queryset.model):
                ...
                filters = {field + "__icontains": q for field in self.search_fields or []}
