...
class TestAddCollection(TestCase, WagtailTestUtils):
    ...
    def test_post(self):
        ...
        root_collection = Collection.get_first_root_node()
        self.assertEqual(Collection.objects.get(name="Holiday snaps").get_parent(), root_collection)
...
class TestEditCollection(TestCase, WagtailTestUtils):
    ...
    def get(self, params={}, collection_id=None):
        return self.client.get(
            reverse("wagtailadmin_collections:edit", args=(collection_id or self.collection.id,)), params
        )

    def post(self, post_data={}, collection_id=None):
        return self.client.post(
            reverse("wagtailadmin_collections:edit", args=(collection_id or self.collection.id,)), post_data
        )
    ...
    def test_cannot_move_parent_collection_to_descendant(self):
        ...
        self.assertEqual(Collection.objects.get(pk=self.l2.pk).get_parent().pk, self.l1.pk)
...
class TestDeleteCollection(TestCase, WagtailTestUtils):
    ...
    def get(self, params={}, collection_id=None):
        return self.client.get(
            reverse("wagtailadmin_collections:delete", args=(collection_id or self.collection.id,)), params
        )

    def post(self, post_data={}, collection_id=None):
        return self.client.post(
            reverse("wagtailadmin_collections:delete", args=(collection_id or self.collection.id,)), post_data
        )
