...
class TestHtmlToContentState(TestCase):
    ...
    def assertContentStateEqual(self, v1, v2, match_keys=False):
        ...
        self.assertTrue(
            ...
            f"{json.dumps(v1, indent=4)} does not match {json.dumps(v2, indent=4)}",
        )
    ...
    def test_external_link(self):
        ...
        self.assertContentStateEqual(
            result,
            {
                "entityMap": {"0": {"mutability": "MUTABLE", "type": "LINK", "data": {"url": "http://wagtail.io"}}},
                "blocks": [
                    {
                        "inlineStyleRanges": [],
    ...
    def test_link_in_bare_text(self):
        converter = ContentstateConverter(features=["link"])
        result = json.loads(converter.from_database_format("""an <a href="http://wagtail.io">external</a> link"""))
        self.assertContentStateEqual(
            result,
            {
                "entityMap": {"0": {"mutability": "MUTABLE", "type": "LINK", "data": {"url": "http://wagtail.io"}}},
    ...
    def test_page_link(self):
        ...
        self.assertContentStateEqual(
            ...
            {
                "entityMap": {
                    "0": {"mutability": "MUTABLE", "type": "LINK", "data": {"id": 3, "url": "/events/", "parentId": 2}}
                },
                "blocks": [
                    {
                        "inlineStyleRanges": [],
    ...
    def test_link_to_root_page(self):
        ...
        self.assertContentStateEqual(
            ...
            {
                "entityMap": {
                    "0": {"mutability": "MUTABLE", "type": "LINK", "data": {"id": 1, "url": None, "parentId": None}}
                },
                "blocks": [
                    {
                        "inlineStyleRanges": [],
    ...
    def test_broken_document_link(self):
        ...
        self.assertContentStateEqual(
            result,
            {
                "entityMap": {"0": {"mutability": "MUTABLE", "type": "DOCUMENT", "data": {"id": 9999}}},
                "blocks": [
                    {
                        "inlineStyleRanges": [],
                        "text": "a document link",
    ...
    def test_hr(self):
        ...
        self.assertContentStateEqual(
            result,
            {
                ...
                "entityMap": {"0": {"data": {}, "mutability": "IMMUTABLE", "type": "HORIZONTAL_RULE"}},
            },
        )
    ...
    def test_add_spacer_paragraph_between_hrs(self):
        ...
        self.assertContentStateEqual(
            result,
            {
                ...
                "entityMap": {
                    "0": {"data": {}, "mutability": "IMMUTABLE", "type": "HORIZONTAL_RULE"},
                    "1": {"data": {}, "mutability": "IMMUTABLE", "type": "HORIZONTAL_RULE"},
                },
            },
        )
...
class TestContentStateToHtml(TestCase):
    ...
    def test_local_link(self):
        ...
        contentstate_json = json.dumps(
            {
                "entityMap": {"0": {"mutability": "MUTABLE", "type": "LINK", "data": {"url": "/some/local/path/"}}},
                "blocks": [
                    {
                        "inlineStyleRanges": [],
                        "text": "an external link",
