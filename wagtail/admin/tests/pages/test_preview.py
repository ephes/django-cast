...
class TestIssue2599(TestCase, WagtailTestUtils):
    ...
    def test_issue_2599(self):
        ...
        preview_url = reverse("wagtailadmin_pages:preview_on_add", args=("tests", "simplepage", homepage.id))
...
class TestPreview(TestCase, WagtailTestUtils):
    ...
    def test_preview_on_create_with_m2m_field(self):
        preview_url = reverse("wagtailadmin_pages:preview_on_add", args=("tests", "eventpage", self.home_page.id))
...
class TestDisablePreviewButton(TestCase, WagtailTestUtils):
    ...
    def test_disable_preview_on_revisions_list(self):
        ...
        preview_url = reverse(
            "wagtailadmin_pages:revisions_view", args=(simple_page.id, simple_page.get_latest_revision().id)
        )
