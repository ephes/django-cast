...
class TestLocking(TestCase, WagtailTestUtils):
    ...
    def test_lock_post_with_bad_redirect(self):
        response = self.client.post(
            reverse("wagtailadmin_pages:lock", args=(self.child_page.id,)), {"next": "http://www.google.co.uk"}
        )
    ...
    def test_unlock_post_with_bad_redirect(self):
        ...
        response = self.client.post(
            reverse("wagtailadmin_pages:unlock", args=(self.child_page.id,)), {"next": "http://www.google.co.uk"}
        )
