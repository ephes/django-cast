...
class TestAdminPageChooserWidget(TestCase):
    ...
    def test_adapt(self):
        ...
        self.assertEqual(
            js_args[2], {"can_choose_root": False, "model_names": ["wagtailcore.page"], "user_perms": None}
        )
...
class TestAdminDateTimeInput(TestCase):
    def test_adapt(self):
        ...
        self.assertEqual(js_args[0], {"dayOfWeekStart": 0, "format": "Y-m-d H:i", "formatTime": "H:i"})
    ...
    def test_adapt_with_custom_format(self):
        ...
        self.assertEqual(js_args[0], {"dayOfWeekStart": 0, "format": "d.m.Y. H:i", "formatTime": "H:i A"})
