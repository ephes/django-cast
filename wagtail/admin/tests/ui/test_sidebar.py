    ...
    def test_adapt(self):
        ...
        self.assertEqual(
            packed,
            {
                ...
                "_args": [{"classnames": "", "icon_name": "", "label": "Link", "name": "link", "url": "/link/"}],
            },
        )

    def test_adapt_with_classnames_and_icon(self):
        packed = JSContext().pack(
            LinkMenuItem("link", "Link", "/link/", icon_name="link-icon", classnames="some classes")
        )
    ...
    def test_adapt_without_footer_text(self):
        ...
        self.assertEqual(
            packed,
            {
                "_type": "wagtail.sidebar.SubMenuItem",
                "_args": [
                    {"name": "sub-menu", "label": "Sub menu", "icon_name": "", "classnames": "", "footer_text": ""},
                    [
                        {
                            "_type": "wagtail.sidebar.LinkMenuItem",
                            "_args": [
    ...
    def test_adapt(self):
        ...
        self.assertEqual(
            packed,
            {
                ...
                "_args": [{"classnames": "", "icon_name": "", "label": "Pages", "name": "pages", "url": "/pages/"}, 1],
            },
        )
...
class TestAdaptWagtailBrandingModule(TestCase):
    def test_adapt(self):
        ...
        self.assertEqual(
            packed["_args"][1].keys(),
            {"desktopLogoBody", "desktopLogoEyeClosed", "desktopLogoEyeOpen", "desktopLogoTail", "mobileLogo"},
        )
...
class TestAdaptCustomBrandingModule(TestCase):
    def test_adapt(self):
        ...
        self.assertEqual(
            packed, {"_type": "wagtail.sidebar.CustomBrandingModule", "_args": ["<h1>My custom branding</h1>", False]}
        )
    ...
    def test_collapsible(self):
        ...
        self.assertEqual(
            packed, {"_type": "wagtail.sidebar.CustomBrandingModule", "_args": ["<h1>My custom branding</h1>", True]}
        )
