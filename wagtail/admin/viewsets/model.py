...
class ModelViewSet(ViewSet):
    ...
    def get_form_class(self, for_update=False):
        ...
        return modelform_factory(
            self.model, formfield_callback=self.formfield_for_dbfield, fields=fields, exclude=exclude
        )
    ...
    def on_register(self):
        ...
        url_finder_class = type(
            ...
            (ModelAdminURLFinder,),
            {"permission_policy": self.permission_policy, "edit_url_name": self.get_url_name("edit")},
        )
