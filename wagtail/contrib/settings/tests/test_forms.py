...
class TestSiteSwitchFromSiteOrdering(TestCase):
    ...
    def test_site_order_by_hostname(self):
        ...
        expected_choices = [
            (f"/admin/settings/tests/testsetting/{site_3.id}/", "alfa.com"),
            (f"/admin/settings/tests/testsetting/{site_2.id}/", "bravo.com [default]"),
            (f"/admin/settings/tests/testsetting/{site_1.id}/", "charly.com"),
        ]
