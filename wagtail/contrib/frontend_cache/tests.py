...
from wagtail.contrib.frontend_cache.backends import BaseBackend, CloudflareBackend, CloudfrontBackend, HTTPBackend
...
class TestBackendConfiguration(TestCase):
    ...
    def test_http_httperror(self):
        ...
        http_error = HTTPError(
            url="http://localhost:8000/home/events/christmas/", code=500, msg="Internal Server Error", hdrs={}, fp=None
        )
...
class TestCachePurgingFunctions(TestCase):
    ...
    def test_purge_batch(self):
        ...
        self.assertEqual(
            PURGED_URLS, ["http://localhost/events/", "http://localhost/events/past/", "http://localhost/foo"]
        )
...
class TestPurgeBatchClass(TestCase):
    ...
    def test_multiple_calls(self):
        ...
        self.assertEqual(
            batch.urls, ["http://localhost/events/", "http://localhost/events/past/", "http://localhost/foo"]
        )
    ...
    def test_http_error_on_cloudflare_purge_batch(self, requests_delete_mock):
        ...
        self.assertIn(
            "Couldn't purge 'http://localhost/events/' from Cloudflare. HTTPError: 500", log_output.output[0]
        )
