...
class WagtailRegisterable:
    ...
    def register_with_wagtail(self):
        ...
        menu_hook = "register_settings_menu_item" if self.add_to_settings_menu else "register_admin_menu_item"
    ...
    def register_admin_url_finders(self):
        if not self.is_pagemodel:
            finder_class = type(
                ...
                (ModelAdminURLFinder,),
                {"permission_helper": self.permission_helper, "url_helper": self.url_helper},
            )
