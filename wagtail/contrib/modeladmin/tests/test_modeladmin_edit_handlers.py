...
class TestExtractPanelDefinitionsFromModelAdmin(TestCase, WagtailTestUtils):
    ...
    def test_model_edit_handler(self):
        ...
        self.assertEqual(
            [field_name for field_name in response.context["form"].fields], ["first_name", "last_name", "phone_number"]
        )
    ...
    def test_model_panels(self):
        ...
        self.assertEqual(
            [field_name for field_name in response.context["form"].fields], ["first_name", "phone_number"]
        )
    ...
    def test_model_admin_edit_handler(self):
        ...
        self.assertEqual(
            [field_name for field_name in response.context["form"].fields], ["last_name", "phone_number", "address"]
        )
    ...
    def test_model_admin_panel_edit_handler_priority(self):
        ...
        form = form_class()
        self.assertEqual([field_name for field_name in form.fields], ["first_name", "last_name", "phone_number"])
        ...
        form_class = edit_handler.get_form_class()
        form = form_class()
        self.assertEqual([field_name for field_name in form.fields], ["last_name", "phone_number", "address"])
        ...
        form_class = edit_handler.get_form_class()
        form = form_class()
        self.assertEqual([field_name for field_name in form.fields], ["phone_number", "address"])
