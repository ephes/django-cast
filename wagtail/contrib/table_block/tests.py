...
class TestTableBlock(TestCase):
    ...
    def test_table_block_render(self):
        ...
        value = {
            ...
            "data": [["Test 1", "Test 2", "Test 3"], [None, None, None], [None, None, None]],
        }
        block = TableBlock()
    ...
    def test_table_block_alignment_render(self):
        ...
        value = {
            ...
            "first_col_is_header": False,
            "cell": [{"row": 0, "col": 1, "className": "htLeft"}, {"row": 1, "col": 1, "className": "htRight"}],
            "data": [["Test 1", "Test 2", "Test 3"], [None, None, None], [None, None, None]],
        }
        block = TableBlock()
        result = block.render(value)
    ...
    def test_do_not_render_html(self):
        ...
        value = {
            "first_row_is_table_header": False,
            "first_col_is_header": False,
            "data": [["<p><strong>Test</strong></p>", None, None], [None, None, None], [None, None, None]],
        }
    ...
    def test_searchable_content(self):
        value = {
            "first_row_is_table_header": False,
            "first_col_is_header": False,
            "data": [["Test 1", "Test 2", "Test 3"], [None, "Bar", None], [None, "Foo", None]],
        }
        block = TableBlock()
...
class TestTableBlockPageEdit(TestCase, WagtailTestUtils):
    ...
    def test_page_edit_page_view(self):
        ...
        self.assertContains(
            response, '<div data-contentpath="table" class="field char_field widget-table_input fieldname-table">'
        )
        # check data
