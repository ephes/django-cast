...
class Elasticsearch5Mapping:
    ...
    def get_mapping(self):
        ...
        fields.update(dict(self.get_field_mapping(field) for field in self.model.get_search_fields()))
...
class Elasticsearch5SearchQueryCompiler(BaseSearchQueryCompiler):
    ...
    def _compile_query(self, query, field, boost=1.0):
        if isinstance(query, MatchAll):
            ...
            return {
                "bool": {
                    "should": [self._compile_query(child_query, field, boost) for child_query in query.subqueries]
                }
            }
        ...
        "settings": {
            "analysis": {
                ...
                "tokenizer": {
                    ...
                    "edgengram_tokenizer": {"type": "edgeNGram", "min_gram": 2, "max_gram": 15, "side": "front"},
                },
                "filter": {
