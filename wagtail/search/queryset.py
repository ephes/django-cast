...
class SearchableQuerySetMixin:
    def search(
        self, query, fields=None, operator=None, order_by_relevance=True, partial_match=True, backend="default"
    ):
        """
    ...
    def autocomplete(self, query, fields=None, operator=None, order_by_relevance=True, backend="default"):
        ...
        return search_backend.autocomplete(
            query, self, fields=fields, operator=operator, order_by_relevance=order_by_relevance
        )
