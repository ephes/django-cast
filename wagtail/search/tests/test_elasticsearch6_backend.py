...
class TestElasticsearch6SearchQuery(TestCase):
    ...
    def test_none_query_string(self):
        ...
        # Check it
        expected_result = {
            "bool": {"filter": {"match": {"content_type": "searchtests.Book"}}, "must": {"match_all": {}}}
        }
        self.assertDictEqual(query.get_query(), expected_result)
    ...
    def test_filter(self):
        ...
        expected_result = {
            "bool": {
                "filter": [{"match": {"content_type": "searchtests.Book"}}, {"term": {"title_filter": "Test"}}],
                "must": {"multi_match": {"query": "Hello", "fields": ["_all_text", "_edgengrams"]}},
            }
        }
        self.assertDictEqual(query.get_query(), expected_result)
    ...
    def test_and_filter(self):
        ...
        query = self.query_compiler_class(
            models.Book.objects.filter(title="Test", publication_date=datetime.date(2017, 10, 18)), "Hello"
        )
    ...
    def test_or_filter(self):
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.filter(Q(title="Test") | Q(publication_date=datetime.date(2017, 10, 18))), "Hello"
        )
    ...
    def test_negated_filter(self):
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.exclude(publication_date=datetime.date(2017, 10, 18)), "Hello"
        )
    ...
    def test_isnull_false_lookup(self):
        ...
        expected_result = {
            "bool": {
                "filter": [{"match": {"content_type": "searchtests.Book"}}, {"exists": {"field": "title_filter"}}],
                "must": {"multi_match": {"query": "Hello", "fields": ["_all_text", "_edgengrams"]}},
            }
        }
        self.assertDictEqual(query.get_query(), expected_result)
    ...
    def test_startswith_lookup(self):
        ...
        expected_result = {
            "bool": {
                "filter": [{"match": {"content_type": "searchtests.Book"}}, {"prefix": {"title_filter": "Test"}}],
                "must": {"multi_match": {"query": "Hello", "fields": ["_all_text", "_edgengrams"]}},
            }
        }
        self.assertDictEqual(query.get_query(), expected_result)
    ...
    def test_phrase_query(self):
        ...
        # Check it
        expected_result = {
            "multi_match": {"fields": ["_all_text", "_edgengrams"], "query": "Hello world", "type": "phrase"}
        }
...
class TestElasticsearch6MappingInheritance(TestCase):
    ...
    def test_get_document(self):
        ...
        expected_result = {
            ...
            "searchtests_novel__protagonist": {"name": "Frodo Baggins", "novel_id_filter": 4},
