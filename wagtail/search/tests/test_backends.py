...
from wagtail.search.backends import InvalidSearchBackendError, get_search_backend, get_search_backends
...
class BackendTests(WagtailTestUtils):
    ...
    def test_search_simple(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results], ["JavaScript: The good parts", "JavaScript: The Definitive Guide"]
        )
    ...
    def test_search_child_class_field_from_parent(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results], ["A Game of Thrones", "A Clash of Kings", "A Storm of Swords"]
        )
    ...
    def test_search_boosting_on_related_fields(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results[1:]], ["The Fellowship of the Ring", "The Two Towers", "The Return of the King"]
        )
    ...
    def test_filter_exact_value(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results], ["The Return of the King", "The Rust Programming Language"]
        )
    ...
    def test_filter_lt(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results],
            ["The Hobbit", "JavaScript: The good parts", "The Fellowship of the Ring", "Foundation", "The Two Towers"],
        )
    ...
    def test_filter_in_list(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results], ["The Return of the King", "The Rust Programming Language", "Learning Python"]
        )
    ...
    def test_filter_isnull_false(self):
        ...
        self.assertUnsortedListEqual(
            [r.name for r in results], ["Isaac Asimov", "George R.R. Martin", "J. R. R. Tolkien"]
        )
    ...
    def test_filter_or_operator(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results], ["Learning Python", "The Return of the King", "The Rust Programming Language"]
        )
    ...
    def test_order_by_relevance(self):
        results = self.backend.search(
            MATCH_ALL, models.Novel.objects.order_by("number_of_pages"), order_by_relevance=False
        )
    ...
    def test_offset_and_limit(self):
        ...
        self.assertListEqual(
            [r.title for r in results], ["The Fellowship of the Ring", "The Return of the King", "A Game of Thrones"]
        )
    ...
    def test_same_rank_pages(self):
        ...
        for i in range(10):
            obj = models.Book.objects.create(
                title="Rank %s" % i, publication_date=date(2017, 10, 18), number_of_pages=100
            )
            index.add_item(obj)
    ...
    def test_plain_text_single_word(self):
        ...
        self.assertSetEqual(
            {r.title for r in results}, {"JavaScript: The Definitive Guide", "JavaScript: The good parts"}
        )
    ...
    def test_plain_text_multiple_words_and(self):
        results = self.backend.search(PlainText("JavaScript Definitive", operator="and"), models.Book.objects.all())
    ...
    def test_boost(self):
        results = self.backend.search(
            PlainText("JavaScript Definitive") | Boost(PlainText("Learning Python"), 2.0), models.Book.objects.all()
        )
        ...
        results = self.backend.search(
            PlainText("JavaScript Definitive") | Boost(PlainText("Learning Python"), 0.5), models.Book.objects.all()
        )
    ...
    def test_and(self):
        results = self.backend.search(
            And([PlainText("javascript"), PlainText("definitive")]), models.Book.objects.all()
        )
        self.assertSetEqual({r.title for r in results}, {"JavaScript: The Definitive Guide"})
...
@override_settings(WAGTAILSEARCH_BACKENDS={"default": {"BACKEND": "wagtail.search.backends.db"}})
class TestBackendLoader(TestCase):
    ...
    def test_nonexistent_backend_import(self):
        self.assertRaises(InvalidSearchBackendError, get_search_backend, backend="wagtail.search.backends.doesntexist")
