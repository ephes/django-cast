    ...
    def get_edit_url(self, instance):
        if self.user_can_edit:
            return reverse(
                ...
                args=(self.model._meta.app_label, self.model._meta.model_name, quote(instance.pk)),
            )
...
def get_snippet_usage_url(self):
    return reverse("wagtailsnippets:usage", args=(self._meta.app_label, self._meta.model_name, quote(self.pk)))
