...
def register_images_menu_item():
    return ImagesMenuItem(_("Images"), reverse("wagtailimages:index"), name="images", icon_name="image", order=300)
...
def register_images_search_area():
    return ImagesSearchArea(_("Images"), reverse("wagtailimages:index"), name="images", icon_name="image", order=200)
