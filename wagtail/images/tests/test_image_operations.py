...
class ImageTransformOperationTestCase(TestCase):
    ...
    def make_filter_spec_error_test(cls, filter_spec):
        ...
        test_filter_spec_error.__name__ = str(f"test_filter_{filter_spec}_raises_{InvalidFilterSpecError.__name__}")
