...
def chooser(request):
    ...
    return render_modal_workflow(
        request, "wagtailembeds/chooser/chooser.html", None, {"form": form}, json_data={"step": "chooser"}
    )
        ...
        if form.is_valid():
            ...
            try:
                ...
                return render_modal_workflow(
                    ...
                    None,
                    None,
                    json_data={"step": "embed_chosen", "embed_html": embed_html, "embed_data": embed_data},
                )
