...
class TestUserDeleteView(TestCase, WagtailTestUtils):
    def setUp(self):
        ...
        self.superuser = self.create_superuser(
            username="testsuperuser", email="testsuperuser@email.com", password="password"
        )
...
class TestUserDeleteViewForNonSuperuser(TestCase, WagtailTestUtils):
    def setUp(self):
        ...
        deleters_group.permissions.add(
            Permission.objects.get(content_type__app_label=AUTH_USER_APP_LABEL, codename=delete_user_perm_codename)
        )
...
class TestUserEditViewForNonSuperuser(TestCase, WagtailTestUtils):
    def setUp(self):
        ...
        editors_group.permissions.add(
            Permission.objects.get(content_type__app_label=AUTH_USER_APP_LABEL, codename=change_user_perm_codename)
        )
...
class TestGroupEditView(TestCase, WagtailTestUtils):
    ...
    def test_group_edit_adding_document_permissions_same_collection(self):
        ...
        self.assertEqual(
            self.test_group.collection_permissions.filter(permission__content_type__app_label="wagtaildocs").count(), 1
        )
        response = self.post(
            {
                "document_permissions-0-permissions": [self.add_doc_permission.pk, self.change_doc_permission.pk],
            }
        )
        ...
        self.assertEqual(
            self.test_group.collection_permissions.filter(permission__content_type__app_label="wagtaildocs").count(), 2
        )
    ...
    def test_group_edit_adding_document_permissions_different_collection(self):
        ...
        response = self.post(
            {
                ...
                "document_permissions-1-permissions": [self.add_doc_permission.pk, self.change_doc_permission.pk],
            }
        )
        ...
        self.assertEqual(
            self.test_group.collection_permissions.filter(permission__content_type__app_label="wagtaildocs").count(), 3
        )
    ...
    def test_group_edit_deleting_document_permissions(self):
        ...
        self.assertEqual(
            self.test_group.collection_permissions.filter(permission__content_type__app_label="wagtaildocs").count(), 0
        )
    ...
    def test_group_edit_loads_with_page_permissions_shown(self):
        ...
        self.assertEqual(page_permissions_formset.forms[0]["page"].value(), self.root_page.pk)
        self.assertEqual(set(page_permissions_formset.forms[0]["permission_types"].value()), {"add", "edit"})
