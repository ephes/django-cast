...
change_user_perm = f"{AUTH_USER_APP_LABEL}.change_{AUTH_USER_MODEL_NAME.lower()}"
delete_user_perm = f"{AUTH_USER_APP_LABEL}.delete_{AUTH_USER_MODEL_NAME.lower()}"
...
def register_users_search_area():
    return UsersSearchArea(_("Users"), reverse("wagtailusers_users:index"), name="users", icon_name="user", order=600)
