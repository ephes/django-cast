...
def upload_avatar_to(instance, filename):
    ...
    return os.path.join("avatar_images", f"avatar_{uuid.uuid4()}_{filename}{ext}")
...
class UserProfile(models.Model):
    ...
    preferred_language = models.CharField(
        verbose_name=_("preferred language"), max_length=10, help_text=_("Select language for the admin"), default=""
    )

    current_time_zone = models.CharField(
        verbose_name=_("current time zone"), max_length=40, help_text=_("Select your current time zone"), default=""
    )
