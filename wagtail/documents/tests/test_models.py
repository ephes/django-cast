...
class TestDocumentFilenameProperties(TestCase):
    ...
    def test_content_disposition(self):
        self.assertEqual(
            """attachment; filename=example.doc; filename*=UTF-8''example.doc""", self.document.content_disposition
        )
...
class TestFilesDeletedForCustomModels(TestFilesDeletedForDefaultModels):
    ...
    def test_document_model(self):
        ...
        self.assertEqual(f"{cls._meta.app_label}.{cls.__name__}", "tests.CustomDocument")
