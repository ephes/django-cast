...
class CollectionViewRestriction(BaseViewRestriction):
    collection = models.ForeignKey(
        "Collection", verbose_name=_("collection"), related_name="view_restrictions", on_delete=models.CASCADE
    )
...
class GroupCollectionPermission(models.Model):
    ...
    group = models.ForeignKey(
        Group, verbose_name=_("group"), related_name="collection_permissions", on_delete=models.CASCADE
    )
    collection = models.ForeignKey(
        Collection, verbose_name=_("collection"), related_name="group_permissions", on_delete=models.CASCADE
    )
