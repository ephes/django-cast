...
class TestCoreGlobalsAndFilters(TestCase):
    ...
    def test_richtext(self):
        ...
        self.assertEqual(
            self.render("{{ text|richtext }}", {"text": richtext}), '<p>Merry <a href="/">Christmas</a>!</p>'
        )
...
class TestIncludeBlockTag(TestCase):
    ...
    def test_include_block_tag_with_additional_variable(self):
        ...
        result = render_to_string(
            "tests/jinja2/include_block_tag_with_additional_variable.html", {"test_block": bound_block}
        )
