...
from wagtail.core.models import Page, PageLogEntry, PageViewRestriction, Task, Workflow, WorkflowTask
...
class TestAuditLogHooks(TestCase, WagtailTestUtils):
    ...
    def test_action_must_be_registered(self):
        ...
        self.assertEqual(
            e.exception.message_dict, {"action": ["The log action 'test.custom_action' has not been registered."]}
        )
