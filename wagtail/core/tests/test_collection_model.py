...
class TestCollectionTreeOperations(TestCase):
    ...
    def test_get_descendants(self):
        ...
        self.assertEqual(
            ...
            [self.root_collection, self.evil_plans_collection, self.holiday_photos_collection],
        )
    ...
    def test_get_next_siblings(self):
        self.assertEqual(
            list(self.evil_plans_collection.get_next_siblings().order_by("path")), [self.holiday_photos_collection]
        )
        self.assertEqual(
    ...
    def test_get_prev_siblings(self):
        self.assertEqual(
            list(self.holiday_photos_collection.get_prev_siblings().order_by("path")), [self.evil_plans_collection]
        )
