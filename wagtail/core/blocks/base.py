...
class BoundBlock:
    ...
    def __repr__(self):
        return f"<block {self.block.name or type(self.block).__name__}: {self.value!r}>"
...
@lru_cache(maxsize=1)
def get_help_icon():
    return render_to_string("wagtailadmin/shared/icon.html", {"name": "help", "class_name": "default"})
