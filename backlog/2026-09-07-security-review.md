...
- **Admin media probe and concurrency limits (fixed 2026-09-16):** Wagtail
  ...
  `CAST_MEDIA_PROBE_SECONDS`. Replacement saves also retain the old database
  name and stored file if ingest fails. Implemented by the
  [media-ingestion service plan](2026-09-16-media-ingestion-service.md) slices
  1-4b. No worker-exhaustion test was performed.
