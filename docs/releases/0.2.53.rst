...
- Add View Transitions API support (``transition:true``) for a smooth 350ms
  cross-fade when paginating, using explicit ``cast-fade-out``/``cast-fade-in``
  keyframes. Gracefully degrades in unsupported browsers. Animation is disabled
