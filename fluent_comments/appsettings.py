...
FLUENT_CONTENTS_USE_AKISMET = getattr(
    settings, "FLUENT_CONTENTS_USE_AKISMET", bool(AKISMET_API_KEY)
)  # enable when an API key is set.
FLUENT_COMMENTS_DEFAULT_MODERATOR = getattr(settings, "FLUENT_COMMENTS_DEFAULT_MODERATOR", "default")
FLUENT_COMMENTS_USE_EMAIL_NOTIFICATION = getattr(
    settings, "FLUENT_COMMENTS_USE_EMAIL_NOTIFICATION", True
)  # enable by default
...
FLUENT_COMMENTS_AKISMET_ACTION = getattr(
    settings, "FLUENT_COMMENTS_AKISMET_ACTION", "soft_delete"
)  # or 'moderate', 'delete, 'soft_delete'
...
FLUENT_COMMENTS_COMPACT_COLUMN_CSS_CLASS = getattr(
    settings, "FLUENT_COMMENTS_COMPACT_COLUMN_CSS_CLASS", "col-sm-{size}"
)
